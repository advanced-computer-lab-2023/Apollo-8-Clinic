...
const [MyPatient,setMyPatient] = useState({});
  ...
  const handleSubmit = (event) => {
    ...
    if(!nameFormat.test(name)  )
     { alert('invalid text format');return;}
...
<div>
    ...
    <Card style={{ width: '18rem' }}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" onClick={fn2}>view</Button>
      </Card.Body>
    </Card>
    <Card style={{ width: '18rem' }}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" onClick={fn1}>view</Button>
      </Card.Body>
    </Card>
    </div>): null}
    {familyshow? (
        ...
        {nonlinkedfamily.map(member => (
                ...
                <Button style={{"margin-bottom": "10px"}} onClick={()=>{setaddFamilyMemForm(true);}}>Add a new Family member</Button>
                {addFamilyMemForm? (
